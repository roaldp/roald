...
Responsibilities:
- Append one line per InstructionsLoaded event to a per-project log.
...
Field names verified against a live event on 2026-09-06: the payload carries file_path,
load_reason and memory_type. It does not carry a field called reason.
"""
